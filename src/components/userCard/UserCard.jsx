...
function UserCard({ user, isLoading, error }) {
  ...
  return (
    <div className="nutrition-counts">
      <div>
        ...
        <span className="count-value">{user?.calorieCount}</span>
      </div>
      <div>
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="count-label">Proteins:</span>
        <span className="count-value">{user?.proteinCount}</span>
      </div>
      <div>
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="count-label">Glucides:</span>
        <span className="count-value">{user?.carbohydrateCount}</span>
      </div>
      <div>
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="count-label">Lipides:</span>
        <span className="count-value">{user?.lipidCount}</span>
      </div>
    </div>
